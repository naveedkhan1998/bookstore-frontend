...
import { SettingType, setSettingInfo, getCurrentSettingDetails, Language } from '../features/settingSlice';
  ...
  const handleSettingChange = (settingName: string) => {
    ...
    switch (settingName) {
      case 'emailNotifications':
        ...
        dispatch(setSettingInfo({ ...setting, email_notification: !setting.email_notification }));
        break;
      case 'darkMode':
