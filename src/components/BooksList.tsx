...
const BooksList = () => {
  ...
  return (
    <div className="grid gap-4 grid-cols-[auto-fill,minmax(300,fr)] max-h-full ">
      <div className="flex flex-col gap-2">
        {isSuccess && (
          <div>
            ...
            <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-8 lg:gap-12 xl:gap-16 mb-16">
