...
import { useRegisterUserMutation, useGetLoggedUserQuery, useLazySendEmailQuery } from "../services/userAuthService";
    ...
    <div className="flex justify-center items-top ">
      <div className="w-full max-w-2xl p-8 rounded-md shadow-md bg-main-secondary dark:bg-dark-secondary">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            <FloatingLabel variant="standard" label="Given Name" id="given_name" type="given_name" value={formData.given_name} onChange={handleChange} required />
          </div>
          <div className="mb-4">
            <FloatingLabel variant="standard" label="Family Name" id="family_name" type="family_name" value={formData.family_name} onChange={handleChange} required />
          </div>
          <div className="mb-4">
